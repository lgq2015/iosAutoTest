...
if __name__ == '__main__':
    input_path = InitPath.get_report_path('D511C1ZR62237866-2020-07-02_17.11.55/html')
    # output_path = InitPath.get_report_path('D511C1ZR62237866-2020-07-02_17.11.55')

    os.system("allure open {}".format(input_path))

    # output_name = 'html.zip'
    # myzip = MyZip()
    # myzip.zip_file_path(input_path, output_path, output_name)
